<template>
    <main :class="(route.name?.toString() ?? 'unknown') + '_page'">
        ...
        <Navbar />
        <div class="content min-h-[83.2vh] mb-16">
            <router-view :key="route.fullPath"></router-view>
        </div>
        <footer class="bg-gray-100 py-8">
            <div class="content-container">
                <p>&copy; 2022 eFreedomWall</p>
            </div>
        </footer>
    </main>
</template>
...
import Notification from 'notiwind/src/components/Notification';
import NotificationGroup from 'notiwind/src/components/NotificationGroup';
